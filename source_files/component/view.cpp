...
View::View(RendererController *rendererController, int renderIndex, ComponentSize componentSize, ComponentPosition componentPosition)
...
TextView::TextView(RendererController *rendererController,
	...
	this->texture = SDL_CreateTextureFromSurface(this->rendererController->getSDLRenderer(),
	                                             TTF_RenderText_Solid(this->font, this->text.c_str(), this->textProp.fontColor));
}
